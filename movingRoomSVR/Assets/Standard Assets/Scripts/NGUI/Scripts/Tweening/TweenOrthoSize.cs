...
public class TweenOrthoSize : UITweener
{
	...
	{
		get { return CameraManager.singleton.orthographicSize; }
		set { CameraManager.singleton.orthographicSize = value; }
	}
	...
	{
		CameraManager.singleton.orthographicSize = from * (1f - factor) + to * factor;
	}
