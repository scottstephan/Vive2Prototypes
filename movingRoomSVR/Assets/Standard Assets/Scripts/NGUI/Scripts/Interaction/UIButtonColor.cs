	...
	protected void Init ()
	{
		...
		else
		{
			...
			else
			{
				...
				{
// WEMO::THIS IS NOT A BUG FOR US.					
//					Debug.LogWarning(NGUITools.GetHierarchy(gameObject) + " has nothing for UIButtonColor to color.", this);

////
					//WEMO ADDED::4-3-2013
					// Set the default color. We have buttons that do not have a widget on this gameobject, but on children assets.
					mColor = Color.white;
					////
					//WEMO COMMENTED::4-3-2013. Dont turn off the component because of the above!
//					enabled = false;
///
				}
			}
