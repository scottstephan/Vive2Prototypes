...
public class UIViewport : MonoBehaviour
{
	...
	void Start ()
	{
		...
		if (sourceCamera == null) sourceCamera = CameraManager.GetCurrentCamera();
	}
	...
	void LateUpdate ()
	{
		if (topLeft != null && bottomRight != null)
		{
			...
			if (CameraManager.singleton.orthographicSize != size) CameraManager.singleton.orthographicSize = size;
		}
	}
}