...
class MeshInstancerClicker extends ScriptableWizard {
...
//	private var myRenderer : Renderer;
	...
	@MenuItem("WEMOTools/Mesh Instancer Clicker")
	
	static function MenuItem() {
		ScriptableWizard.DisplayWizard("MeshInstancerClicker", MeshInstancerClicker, "CREATE INSTANCES", "");
	}
