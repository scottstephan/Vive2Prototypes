...
public class FlurryAndroid
{
	...
	// Starts up your Flurry session. Call on application startup. Optionally initializes Flurry Ads/App Cloud/test ads. Passing true for enableTestAdsAndLogging
	// will not only turn on test ads but it will also enable verbose debug logs for Flurry's SDK
...
//		Debug.Log ("METRICS :::: FLURRY SESSION START");

		_plugin.Call( "onStartSession", apiKey, initializeAds, enableTestAdsAndLogging );
	}
...
//		Debug.Log ("METRICS :::: FLURRY SESSION CLOSED");
